...
<div id="container">
	<div id="col-md-6">
		...
		switch ($categorie) {
			case 1:
				echo("<center><p><h3>Stoom Treinen</h3></p></center>");
				break;
			case 2:
				echo("<center><p><h3>Diesel Treinen</h3></p></center>");
				break;
			case 3:
				echo("<center><p><h3>Elektrische Treinen</h3></p></center>");
				break;
			case 4:
				echo("<center><p><h3>Transport Wagon</h3></p></center>");
				break;
			case 5:
				echo("<center><p><h3>Personen Wagon</h3></p></center>");
				break;
